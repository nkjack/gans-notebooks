...
def tensors_as_gray_images(tensors, nrows=1, figsize=(8, 8), titles=[],
                      wspace=0.1, hspace=0.2, cmap='gray'):
    """
    Plots a sequence of pytorch tensors as images.
...
def dataset_first_n_gray(dataset, n, show_classes=False, class_labels=None,
                    random_start=True, **kw):
    """
    Plots first n images of a dataset containing tensor images.
    """
    ...
    return tensors_as_gray_images(first_n_images, titles=titles, **kw)
